...
class Login(QWidget):
    ...
    def initUI(self):
        ...
        pixmap = QPixmap("D:/PYTHON/py_project/App_Project1/View/img/iceberg-minimalist.jpg")
        self.img_label.setPixmap(pixmap.scaled(360,500))
        ...
        palette.setColor(QPalette.ColorRole.Window,QColor("#1b1d21"))
